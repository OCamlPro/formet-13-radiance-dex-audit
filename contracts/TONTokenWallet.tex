...
\begin{itemize}
\item \issueMajor{Need gas check in {\tt TONTokenWallet.transfer}}{a
  {\tt require} should check that the gas is enough to send the {\tt
    internalTransfer} message; Otherwise, tokens might be definitively
  burnt.}
\end{itemize}
...
\item \issueMajor{Need gas check in {\tt
    TONTokenWallet.transferToRecipient}}{a {\tt require} should check
  that there is enough gas to send {\tt internalTransfer} messages;
  Otherwise, tokens could be definitively burnt.}
\end{itemize}
